...
The indexing & search engine and service layer. It consumes the connector
**protocols** (defined in `indexed-protocols`) via **dependency injection** — it
never imports concrete connectors, CLI, or MCP.

## Layer & dependencies

Business-logic layer. May import: protocols (`indexed-protocols`), `indexed_config`,
...
src/core/v1/
  ...
  engine/
    ...
    indexes/
      ...
      indexers/    faiss_indexer.py (IndexFlatL2)
