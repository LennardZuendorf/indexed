...
ap.add_argument(
    ...
    "--basePath",
    required=True,
    help="Path to the root folder from which files will be read.",
)
ap.add_argument(
    "-includePatterns",
    "--includePatterns",
    required=False,
    default=[".*"],
    help="List of file patterns to include into collection",
    nargs="+",
)
ap.add_argument(
    "-excludePatterns",
    ...
    required=False,
    default=[],
    help="List of file patterns to NOT include into collection",
    nargs="+",
)
...
files_document_reader = FilesDocumentReader(
...
collection_name = (
    args["collection"] if args["collection"] else os.path.basename(args["basePath"])
)
files_collection_creator = create_collection_creator(
