...
ap.add_argument(
    ...
    help="Index that will be used for search",
)
...
max_number_of_chunks = (
    args["maxNumberOfChunks"]
    if args["maxNumberOfChunks"] is not None
    else args["maxNumberOfDocuments"] * 3
)
search_result = log_execution_duration(
