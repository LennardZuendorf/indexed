        ...
        "results": [
            {
                ...
                "body": {
                    "storage": {
                        "value": "<p>Test content about authentication</p>"
                    }
                },
                "space": {"key": "TEST"},
            ...
            },
            {
                ...
                "body": {
                    "storage": {
                        "value": "<p>Documentation for REST APIs</p>"
                    }
                },
                "space": {"key": "TEST"},
...
def mock_jira_server():
    ...
    The server responds to:
    - /rest/api/2/search: Returns sample issue data
        ...
        "issues": [
            {
                "id": "10001",
                "key": "TEST-1",
                "self": f"http://localhost:{server.port}/rest/api/2/issue/10001",
                "fields": {
            ...
            },
            {
                "id": "10002",
                "key": "TEST-2",
                "self": f"http://localhost:{server.port}/rest/api/2/issue/10002",
                "fields": {
