...
def test_embedding_service_initialization():
    ...
    service = EmbeddingService(model_name="all-MiniLM-L6-v2", batch_size=16)
...
def test_embedding_service_batch():
    ...
    service = EmbeddingService(model_name="all-MiniLM-L6-v2", batch_size=4)
...
def test_embedding_service_batch_size():
    ...
    for batch_size in [4, 8, 16]:
        service = EmbeddingService(model_name="all-MiniLM-L6-v2", batch_size=batch_size)
